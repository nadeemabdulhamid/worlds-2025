...
class PosnTest {
	...
	void testScale() {
		...
		assertEquals(new Posn(2000, 500), p1.scale(p2));	
		assertEquals(new Posn(-400, 0), p5.scale(p4));
	}
	...
	@Test
	void testBound() {
		assertEquals(new Posn(52, 10), p1.bound(52));
		assertEquals(p1, p1.bound(500));
		assertEquals(new Posn(-20, -50), p5.bound(52));
		assertEquals(new Posn(-20, -35), p5.bound(35));
		assertEquals(new Posn(-1, -1), p5.bound(1));
	}
